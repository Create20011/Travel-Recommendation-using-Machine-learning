...
<body>
  ...
  <nav class="navbar navbar-default navbar-trans navbar-expand-lg fixed-top">
    ...
    <a class="navbar-brand text-brand" href="#">Solivagent : Tour Guide<span class="color-b"></span></a>
        ...
        <ul class="navbar-nav">
          <li class="nav-item">
            <a class="nav-link active" href="Home.aspx">Home</a>
              ...
              <li class="nav-item">
                  <a class="nav-link" target="_blank" href="https://flight-fare-predictor-0.herokuapp.com">Airline</a>
              </li>
           <li class="nav-item">
              ...
              <div class="row">
                <div class="col-lg-8">
                  <div class="intro-body">
                    <p class="intro-title-top">India, Arunachal-Pradesh
                      <br> 78345</p>
                    <h1 class="intro-title mb-4">
                      <span class="color-b">204 </span> Mount
                      <br> Ziro Valley</h1>
                    <p class="intro-subtitle intro-price">
                      <a href="#"><span class="price-a">Package | 25000</span></a>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div class="table-cell">
            <div class="container">
              <div class="row">
                <div class="col-lg-8">
                  <div class="intro-body">
                    <p class="intro-title-top">India, Himachal Pradesh
                      <br> 78345</p>
                    <h1 class="intro-title mb-4">
                      <span class="color-b">204 </span> Rino
                      <br>  PARSHURAM KUND TEMPLE</h1>
                    <p class="intro-subtitle intro-price">
                      <a href="#"><span class="price-a">Package | 25000</span></a>
                    </p>
                  </div>
          ...
          <div class="table-cell">
            <div class="container">
              <div class="row">
                <div class="col-lg-8">
                  <div class="intro-body">
                    <p class="intro-title-top">India, Kashmir
                      <br> 78345</p>
                    <h1 class="intro-title mb-4">
