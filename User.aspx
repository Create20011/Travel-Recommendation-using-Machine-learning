      ...
      <div class="row">
        <div class="col-md-12 col-lg-8">
          <div class="title-single-box">
            ...
            <span class="color-text-a">Things you Can Do while booking a Tour</span>
              <li>Post one Picture for FREE</li>
               <li>Set Tour alerts for your requirement</li>
               <li>Get instant queries over Phone, Email and SMS</li>
               <li>Performance in  Track responses & views online</li>
                  ...
                  <div class="col-md-12">
                    <%--<button type="submit" class="btn btn-a">Send Message</button>--%>
                      <asp:Button ID="Button1" runat="server" Text="Submit"  class="btn btn-a" OnClick="Button1_Click"/>
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a id="HyperLink1" runat="server" href="admin.aspx">Admin Login</a>
                  </div>
                </div>
              </form>
            </div>
